(function(){const GHL_BOOKING_URL='https://api.leadconnectorhq.com/widget/booking/OoJsvpiXXpwS5oGbQGIE';const _pp=location.pathname;const _dr=(document.body&&document.body.dataset.root)||'';const _hasDR=_dr!=='';const B=_hasDR?_dr:(/\/(lokaal|fr|en)\//.test(_pp)?'../':'');const P=_hasDR?_dr:(/\/lokaal\//.test(_pp)?'../':'');const BOOKING_FALLBACK=P+'Contact.html';const _LG=/\/fr\//.test(_pp)?'fr':/\/en\//.test(_pp)?'en':'nl';const _T={nl:{main:'Hoofdmenu',home:'Home',services:'Diensten',portfolio:'Portfolio',about:'Over ons',contact:'Contact',demo:'Gratis demo',book:'Plan een gesprek',bookFree:'Plan een gratis gesprek',lang:'Taal',menu:'Menu',close:'Sluiten',packages:'Pakketten',solutions:'Oplossingen',p1n:'Pakket 1',p1:'Digitale groei',p1p:'€150 / maand',p1d:'Website, Google, reviews, CRM en automatisering',p2n:'Pakket 2',p2:'AI Consulting',p2p:'Op aanvraag',p2d:'Een persoonlijk AI-plan voor jouw bedrijf',all:'Alle diensten en prijzen',s1:'AI Chatbots',s1d:'Beantwoordt vragen en boekt afspraken, 24/7',s2:'AI Voice Agents',s2d:'Neemt elke oproep aan, dag en nacht',s3:'Websites',s3d:'Snel, mobiel en gemaakt om te converteren',s4:'AI-automatisering',s4d:'Opvolging en herinneringen op de achtergrond',s5:'Online afsprakensysteem',s5d:'Je agenda vult zichzelf',nw:'Nieuw',caseK:'Uitgelichte case',caseT:'Clinic3D, Hasselt',caseA:'bevestigde afspraken',caseB:'no-shows',caseGo:'Lees de case',made:'Gemaakt in Limburg'},en:{main:'Main menu',home:'Home',services:'Services',portfolio:'Portfolio',about:'About us',contact:'Contact',demo:'Free demo',book:'Book a call',bookFree:'Book a free call',lang:'Language',menu:'Menu',close:'Close',packages:'Packages',solutions:'Solutions',p1n:'Package 1',p1:'Digital Growth',p1p:'€150 / month',p1d:'Website, Google, reviews, CRM and automation',p2n:'Package 2',p2:'AI Consulting',p2p:'On request',p2d:'A personal AI plan for your business',all:'All services and prices',s1:'AI Chatbots',s1d:'Answer questions and book appointments, 24/7',s2:'AI Voice Agents',s2d:'Pick up every call, day and night',s3:'Websites',s3d:'Fast, mobile and built to convert',s4:'AI automation',s4d:'Follow-up and reminders in the background',s5:'Online booking system',s5d:'Your calendar fills itself',nw:'New',caseK:'Featured case',caseT:'Clinic3D, Hasselt',caseA:'confirmed appointments',caseB:'no-shows',caseGo:'Read the case',made:'Made in Limburg'},fr:{main:'Menu principal',home:'Accueil',services:'Services',portfolio:'Portfolio',about:'À propos',contact:'Contact',demo:'Démo gratuite',book:'Planifier un appel',bookFree:'Planifier un appel gratuit',lang:'Langue',menu:'Menu',close:'Fermer',packages:'Packs',solutions:'Solutions',p1n:'Pack 1',p1:'Croissance digitale',p1p:'150 € / mois',p1d:'Site web, Google, avis, CRM et automatisation',p2n:'Pack 2',p2:'Consulting IA',p2p:'Sur demande',p2d:'Un plan IA personnalisé pour votre entreprise',all:'Tous les services et tarifs',s1:'Chatbots IA',s1d:'Répondent aux questions et prennent des rendez-vous, 24h/24',s2:'Agents vocaux IA',s2d:'Répondent à chaque appel, jour et nuit',s3:'Sites web',s3d:'Rapides, mobiles et conçus pour convertir',s4:'Automatisation IA',s4d:'Suivi et rappels en arrière-plan',s5:'Prise de rendez-vous en ligne',s5d:'Votre agenda se remplit tout seul',nw:'Nouveau',caseK:'Étude de cas',caseT:'Clinic3D, Hasselt',caseA:'rendez-vous confirmés',caseB:'no-shows',caseGo:'Lire l’étude de cas',made:'Fait au Limbourg'}}[_LG];const _SV=(d,w)=>'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="'+(w||1.8)+'" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">'+d+'</svg>';const _CHEV=_SV('<path d="M6 9l6 6 6-6"/>',2.2);const _ARR='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 8h10M9 4l4 4-4 4"/></svg>';const _NLT=_LG!=='nl'?'<em class="nv-tag">NL</em>':'';const _SOLS=[[P+'AI Chatbots.html','<path d="M21 11.5a8.4 8.4 0 0 1-12.3 7.4L3 21l1.9-5.7A8.4 8.4 0 1 1 21 11.5z"/>',_T.s1,_T.s1d,''],[P+'AI Voice Agents.html','<rect x="9" y="3" width="6" height="11" rx="3"/><path d="M5 11a7 7 0 0 0 14 0M12 18v3"/>',_T.s2,_T.s2d,''],[P+'Websites.html','<rect x="3" y="4" width="18" height="13" rx="2"/><path d="M8 21h8M12 17v4"/>',_T.s3,_T.s3d,''],[P+'AI-Automatisering.html','<circle cx="5" cy="6" r="2.5"/><circle cx="19" cy="6" r="2.5"/><circle cx="12" cy="18" r="2.5"/><path d="M7.5 6h9M6.3 8.2l4.4 7.6M17.7 8.2l-4.4 7.6"/>',_T.s4,_T.s4d,''],[B+'Afsprakensysteem.html','<rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18M8 3v4M16 3v4M8.5 15l2 2 4-4"/>',_T.s5,_T.s5d,'<em class="nv-tag is-new">'+_T.nw+'</em>'+_NLT]].map((x)=>'<a href="'+x[0]+'"><span class="nv-ic">'+_SV(x[1])+'</span><span class="nv-sol-t"><b>'+x[2]+x[4]+'</b><small>'+x[3]+'</small></span></a>').join('');const _PACKS='<a class="nv-pack" href="'+P+'Diensten.html#pakket-1"><span class="n">'+_T.p1n+'</span><b>'+_T.p1+'</b><span class="pr">'+_T.p1p+'</span><small>'+_T.p1d+'</small></a><a class="nv-pack is-prem" href="'+P+'Diensten.html#pakket-2"><span class="n">'+_T.p2n+' · ✦ Premium</span><b>'+_T.p2+'</b><span class="pr">'+_T.p2p+'</span><small>'+_T.p2d+'</small></a>';const NAV=`
    ...
    <div class="wrap">
      <nav class="nv-bar" aria-label="${_T.main}">
        ...
        <div class="nv-links">
          ...
          <a class="nv-link" href="${P}Portfolio.html" data-nav="portfolio">${_T.portfolio}</a>
          <a class="nv-link" href="${P}Over ons.html" data-nav="over_ons">${_T.about}</a>
          <a class="nv-link" href="${P}Contact.html" data-nav="contact">${_T.contact}</a>
        </div>
        <div class="nv-right">
          <div class="nv-lang">
          ...
          <a class="nv-demo" href="${P}Gratis Demo.html" data-nav="gratis_demo"><i><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg></i>${_T.demo}</a>
          <a class="nv-cta" href="${P}Contact.html" data-book>${_T.book}${_ARR}</a>
      ...
      <div class="nv-mega" id="nvMega">
        <div class="nv-mega-in">
          <div class="nv-col">
            ...
            ${_PACKS}
            <a class="nv-all" href="${P}Diensten.html">${_T.all}${_ARR}</a>
          </div>
          <div class="nv-col">
            <span class="nv-kick">${_T.solutions}</span>
            <div class="nv-sols">${_SOLS}</div>
          </div>
          <a class="nv-feature" href="${B}Clinic3D.html">
  ...
  <div class="nv-sheet" id="mobnav" aria-hidden="true" data-no-i18n="">
    ...
    <nav class="nv-sheet-links" aria-label="${_T.main}">
      <a href="${P}index.html" data-nav="home">${_T.home}${_ARR}</a>
      <div class="nv-acc">
      ...
      <a href="${P}Portfolio.html" data-nav="portfolio">${_T.portfolio}${_ARR}</a>
      <a href="${P}Over ons.html" data-nav="over_ons">${_T.about}${_ARR}</a>
      <a href="${P}Gratis Demo.html" data-nav="gratis_demo">${_T.demo}${_ARR}</a>
      <a href="${P}Contact.html" data-nav="contact">${_T.contact}${_ARR}</a>
    </nav>
    <div class="nv-sheet-foot">
      <a class="nv-cta" href="${P}Contact.html" data-book>${_T.bookFree}${_ARR}</a>
  ...
  <footer class="foot">
    ...
    <div class="wrap">
      <div class="foot-inner">
        ...
        <div class="foot-grid">
          <div class="foot-cell">
            ...
            <div class="foot-links">
              ...
              <a href="${P}Diensten.html">websites</a><a href="${P}Diensten.html">ai-automatisering</a><a href="${B}Afsprakensysteem.html">online afspraken</a>
          ...
          <div class="foot-cell one">
            ...
            <div class="foot-links">
              ...
              <a href="${P}Portfolio.html">portfolio</a><a href="${B}emtimes/index.html">em_times</a><a href="${B}lokaal/index.html">regio's</a><a href="${P}Gratis Demo.html">gratis_demo</a><a href="${P}Contact.html">contact</a>
            </div>
          </div>
          <div class="foot-cell">
        ...
        <div class="foot-bot">
          <span>© 2026 <b>EM_LAUNCHPAD</b> · BTW BE1024.977.818 · <a href="${P}privacy.html">privacy</a></span>
...
})();(function(){var _lang=/\/fr\//.test(_pp)?'fr':/\/en\//.test(_pp)?'en':'nl';var _file=_pp.split('/').pop()||'index.html';var _inLok=/\/lokaal\//.test(_pp);function _t(t){if(_inLok)return t==='nl'?null:'/'+t+'/index.html';var _fb=document.body.dataset.langFallback;if(_fb&&t!=='nl')return '/'+t+'/'+_fb;return (t==='nl'?'/':'/'+t+'/')+_file;}if(window.EMi18n)window.EMi18n.apply(_lang);document.querySelectorAll('.nv-lang-menu [data-setlang], .nv-sheet-lang [data-setlang]').forEach(function(b){b.classList.toggle('active',b.dataset.setlang===_lang);b.addEventListener('click',function(e){e.preventDefault();var u=_t(b.dataset.setlang);if(u)location.href=u;});});})();(function(){const loader=document.getElementById('loader');if(!loader)return;let seen=false;try{seen=sessionStorage.getItem('em_loaded')==='1';}catch(e){}
...
lastFocus=document.activeElement;overlay.classList.add('open');document.body.style.overflow='hidden';setTimeout(()=>overlay.querySelector('.ghl-close').focus(),60);};window.closePopup=function(){if(!overlay)return;overlay.classList.remove('open');document.body.style.overflow='';if(lastFocus&&lastFocus.focus)lastFocus.focus();};document.addEventListener('keydown',(e)=>{if(e.key==='Escape'&&overlay&&overlay.classList.contains('open'))closePopup();});document.addEventListener('click',(e)=>{const t=e.target.closest&&e.target.closest('[data-book]');if(!t)return;e.preventDefault();e.stopPropagation();window.openPopup();},true);})();(function(){try{if(localStorage.getItem('em_cookie'))return;}catch(e){return;}var _cl=/\/fr\//.test(_pp)?'fr':/\/en\//.test(_pp)?'en':'nl';var _ct={nl:{t:'We gebruiken cookies om de site te laten werken en te verbeteren.',a:'Accepteren',d:'Weigeren',l:'Privacybeleid'},fr:{t:'Nous utilisons des cookies pour faire fonctionner et ameliorer le site.',a:'Accepter',d:'Refuser',l:'Confidentialite'},en:{t:'We use cookies to run and improve the site.',a:'Accept',d:'Decline',l:'Privacy policy'}}[_cl];var bar=document.createElement('div');bar.className='ck-bar';bar.setAttribute('role','dialog');bar.setAttribute('aria-label','cookies');bar.innerHTML='<p>'+_ct.t+' <a href="'+P+'privacy.html">'+_ct.l+'</a></p><div class="ck-btns"><button class="ck-no" type="button">'+_ct.d+'</button><button class="ck-yes" type="button">'+_ct.a+'</button></div>';document.body.appendChild(bar);requestAnimationFrame(function(){bar.classList.add('show');});function _cd(v){try{localStorage.setItem('em_cookie',v);}catch(e){}bar.classList.remove('show');setTimeout(function(){bar.remove();},300);}bar.querySelector('.ck-yes').addEventListener('click',function(){_cd('all');});bar.querySelector('.ck-no').addEventListener('click',function(){_cd('essential');});})();})();