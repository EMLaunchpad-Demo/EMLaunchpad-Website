  ...
  <footer class="foot">
    ...
    <div class="wrap">
      <div class="foot-inner">
        ...
        <div class="foot-bot">
          <span>© 2026 <b>EM_LAUNCHPAD</b> · BTW BE1024.977.818 · <a href="${P}privacy.html">privacy</a> · <a href="#" data-cookie-open>cookies</a></span>
...
})();(function(){var _lang=/\/fr\//.test(_pp)?'fr':/\/en\//.test(_pp)?'en':'nl';var _file=_pp.split('/').pop()||'index.html';var _inLok=/\/lokaal\//.test(_pp);function _t(t){if(t===_lang)return null;if(_inLok)return t==='nl'?null:'/'+t+'/index.html';var _fb=document.body.dataset.langFallback;if(_fb&&t!=='nl')return '/'+t+'/'+_fb;return (t==='nl'?'/':'/'+t+'/')+_file;}if(window.EMi18n)window.EMi18n.apply(_lang);document.querySelectorAll('.nv-lang-menu [data-setlang], .nv-sheet-lang [data-setlang]').forEach(function(b){b.classList.toggle('active',b.dataset.setlang===_lang);b.addEventListener('click',function(e){e.preventDefault();var u=_t(b.dataset.setlang);if(u)location.href=u;});});})();(function(){const loader=document.getElementById('loader');if(!loader)return;let seen=false;try{seen=sessionStorage.getItem('em_loaded')==='1';}catch(e){}
...
el.innerHTML='<div class="ck-top"><span class="ck-ic">'+ICON+'</span><b id="ckTitle">'+C.h+'</b></div><p>'+C.t+' <a href="'+P+'privacy.html">'+C.l+'</a></p><div class="ck-btns"><button type="button" class="ck-btn ck-no">'+C.d+'</button><button type="button" class="ck-btn ck-yes">'+C.a+'</button></div>';
