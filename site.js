    ...
    <div class="wrap">
      ...
      <div class="nv-mega" id="nvMega">
        <div class="nv-mega-in">
          ...
          <a class="nv-feature" href="${B}Clinic3D">
        ...
        <div class="foot-grid">
          <div class="foot-cell">
            ...
            <div class="foot-links">
              ...
              <a href="${P}Diensten">websites</a><a href="${P}Diensten">ai-automatisering</a><a href="${B}Afsprakensysteem">online afspraken</a>
