(function(){const GHL_BOOKING_URL='https://api.leadconnectorhq.com/widget/booking/OoJsvpiXXpwS5oGbQGIE';const _pp=location.pathname;const _dr=(document.body&&document.body.dataset.root)||'';const _hasDR=_dr!=='';const B=_hasDR?_dr:(/\/(lokaal|fr|en)\//.test(_pp)?'../':'');const P=_hasDR?_dr:(/\/lokaal\//.test(_pp)?'../':'');const BOOKING_FALLBACK=P+'Contact.html';const NAV=`
    ...
    <div class="wrap">
      <nav class="nav-bar">
        ...
        <div class="nav-links">
          ...
          <a href="${P}Portfolio.html" data-nav="portfolio">portfolio</a>
  ...
  <div class="mobnav" id="mobnav" aria-hidden="true">
    ...
    <nav class="mobnav-links">
      ...
      <a href="${P}Portfolio.html" data-nav="portfolio"><span>portfolio</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 6l6 6-6 6"/></svg></a>
